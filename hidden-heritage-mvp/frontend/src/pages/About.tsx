            ...
            <div style={{ 
                ...
                <div className="container" style={{ maxWidth: '800px' }}>
                    <motion.h1 
                        ...
                        style={{ fontSize: '3rem', marginBottom: '1.5rem', color: 'var(--color-text)' }}
                    >
            ...
            <div className="container" style={{ padding: '0 2rem 4rem' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '3rem', marginBottom: '6rem' }}>
                    <div className="card" style={{ padding: '2rem', textAlign: 'center' }}>
                        ...
                        <h3 style={{ fontSize: '1.25rem', marginBottom: '0.5rem' }}>Preservation</h3>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem' }}>
                        ...
                        <div className="card" style={{ overflow: 'hidden' }}>
                            ...
                            <div style={{ padding: '1.5rem' }}>
                                <h3 style={{ fontSize: '1.25rem', marginBottom: '0.25rem' }}>Arjun Verma</h3>
                        ...
                        <div className="card" style={{ overflow: 'hidden' }}>
                            ...
                            />
                            <div style={{ padding: '1.5rem' }}>
                                <h3 style={{ fontSize: '1.25rem', marginBottom: '0.25rem' }}>Priya Singh</h3>
                        ...
                        <div className="card" style={{ overflow: 'hidden' }}>
                            ...
                            />
                            <div style={{ padding: '1.5rem' }}>
                                <h3 style={{ fontSize: '1.25rem', marginBottom: '0.25rem' }}>Rahul Mehta</h3>
