...
const SiteDetail = () => {
    ...
    return (
        <>
            ...
            <div style={{
                height: '60vh',
                backgroundImage: `url(${site.image_url || 'https://placehold.co/1200x600'})`,
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                    <h1 style={{ fontSize: '3rem' }}>{site.name}</h1>
                    <p style={{ fontSize: '1.2rem' }}>{site.type} | {site.avg_visit_time_mins} mins visit</p>
                </div>
            </div>

            <div style={{ maxWidth: '1000px', margin: '3rem auto', padding: '0 2rem', display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '3rem' }}>

                {/* Main Content */}
                <div>
                    <p style={{ fontSize: '1.2rem', lineHeight: '1.8' }}>{site.full_description || site.short_description}</p>
